    ...
    class Program
    {
        static void Main (string[] args)
        {
            ...
            */
            ...
            Console.WriteLine ("Básica (entre com B ou básica);");
            Console.WriteLine ("Trigonométricas (entre com T ou trigonométrica)");
            Console.WriteLine ("Raíz quadrada (entre com R ou raíz)");
            Console.WriteLine ();
            string calcDesejada = Console.ReadLine ();

            if (calcDesejada == "básica" || calcDesejada == "B")
            {
                ...
                calc.Num3 = double.Parse (Console.ReadLine ());
                Console.WriteLine ("Entre com o quarto número: ");
                calc.Num4 = double.Parse (Console.ReadLine ());
                ...
                Console.WriteLine ("multiplicação(x ou *)");
                ...
                if (operacaoDesejada == "adição" || operacaoDesejada == "+")
                {
                    Console.WriteLine (calc.soma ());
                }
                else if (operacaoDesejada == "subtração" || operacaoDesejada == "-")
                {
                    Console.WriteLine (calc.subtracao ());
                }
                else if (operacaoDesejada == "multiplicação" || operacaoDesejada == "x" || operacaoDesejada == "*")
                {
                    Console.WriteLine (calc.multiplicacao ());
                }
                else if (operacaoDesejada == "divição" || operacaoDesejada == "/")
                {
                    Console.WriteLine (calc.divisao ());
                }
                else if (operacaoDesejada == "média")
                {
                    Console.WriteLine (calc.media ());
                }

            }
            else if (calcDesejada == "trigonométrica" || calcDesejada == "T")
            {
            ...
            else if (calcDesejada == "raíz" || calcDesejada == "R")
            {
